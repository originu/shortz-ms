...
import shortz.ms.config.KafkaSseConsumer;
import shortz.ms.config.KafkaSseProducer;

@RestController
@RequestMapping("/api/shortz-kafka")
public class ShortzKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ShortzKafkaResource.class);
    ...
    public ShortzKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
